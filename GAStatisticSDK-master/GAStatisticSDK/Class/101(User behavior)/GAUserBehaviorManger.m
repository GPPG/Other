...
@interface GAUserBehaviorManger()<GAUploadProtocol>

@property (nonatomic, strong) GACurrentTimeUploadTool *uploadTool;
@end

static GAUserBehaviorManger *instance;


@implementation GAUserBehaviorManger
...
{
    if (!_uploadTool) {
        _uploadTool = [[GACurrentTimeUploadTool alloc]initWithType:UserBehaviorUploadType];
    }
    return _uploadTool;
}
