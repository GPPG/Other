...
@interface GAAbtestManger()<GAUploadProtocol>
...
static GAAbtestManger *instance;

@implementation GAAbtestManger
...
{
    if (!_uploadTool) {
        _uploadTool = [[GACurrentTimeUploadTool alloc]initWithType:AbUploadType];
    }
    return _uploadTool;
}
@end
