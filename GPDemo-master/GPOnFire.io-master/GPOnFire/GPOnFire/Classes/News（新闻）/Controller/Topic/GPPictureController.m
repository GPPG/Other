...
static NSString * const GPNewCell = @"pictureCell";

@implementation GPPictureController
...
- (void)setupTablView
{
    ...
    // 注册cell
    [self.tableView registerNib:[UINib nibWithNibName:@"GPPictureTableViewCell" bundle:nil] forCellReuseIdentifier:GPNewCell];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    GPPictureTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:GPNewCell];
