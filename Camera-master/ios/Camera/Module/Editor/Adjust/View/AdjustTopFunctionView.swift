...
class AdjustTopFunctionView: UIView {
    ...
    lazy var lastStepBtn: UIButton = {
        ...
        lastStepBtn.addTarget(self, action: #selector(lastStepBtnAction), for: UIControl.Event.touchUpInside)
        return lastStepBtn
    }()
    ...
    lazy var nextStepBtn: UIButton = {
        ...
        nextStepBtn.addTarget(self, action: #selector(nextStepBtnAction), for: UIControl.Event.touchUpInside)
        return nextStepBtn
    }()
