...
@objc open class PhotoPickerConfiguration: NSObject {
    ...
    // 选择按钮宽度
    @objc public var selectButtonWidth: CGFloat = 0

    // 选择按钮高度
    @objc public var selectButtonHeight: CGFloat = 0
    ...
    // 顶部栏高度
    @objc public var topBarHeight: CGFloat = 88
    ...
    // 底部栏高度
    @objc public var bottomBarHeight: CGFloat = 0
    ...
    // 取消按钮的标题
    @objc public var cancelButtonTitle = "icon-close-54"
    ...
    // 标题按钮的标题字体
    @objc public var titleButtonTextFont = UIFont.systemFont(ofSize: 17, weight: UIFont.Weight.bold)
//        UIFont.systemFont(ofSize: 18)
    ...
    // 箭头图标
    @objc public var titleButtonArrow = UIImage(named: "icon-arrow-down")
