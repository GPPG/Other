...
//    if (captureAsYUV && [GPUImageContext deviceSupportsRedTextures])
    ...
    {
        NSLog(@"Couldn't add photo output");
        return nil;
    }
...
#pragma mark -
#pragma mark MOD: 管理静态照片方法
//这个方法不存在于原版的GPUImage
- (void)capturePhotoWithSettings:(AVCapturePhotoSettings *)settings delegate:(nonnull id<AVCapturePhotoCaptureDelegate>)delegate;
{
    [photoOutput capturePhotoWithSettings:settings delegate:delegate];
}

#pragma mark -
#pragma mark MOD: 管理闪光灯的方法
/** 0:关 1:开 2:自动 */
...
- (AVCaptureFlashMode)getFlashlightMode;{
